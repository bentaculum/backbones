...
def test_resnet_2d_valid_output_ones(downsample_factors, batch_norm):
...
@pytest.mark.parametrize("downsample_factors", [(2, 2), (1, 2, 3)])
def test_resnet_2d_fc(downsample_factors):
    m = Resnet2d(
        in_channels=3,
        initial_fmaps=4,
        downsample_factors=downsample_factors,
